...
```{r}
UPC <- updateCorrespondenceTable(A, B, AStar, AB, AAStar, CSVout= file.path(tmp_dir,"updateCorrespondenceTableCase1.csv"),
                                 "B", 0.4, 0.4, TRUE)
...
```{r, results = "hide"}
UPC <- updateCorrespondenceTable(A, B, AStar, AB, AAStar, CSVout =  file.path(tmp_dir,"updateCorrespondenceTableCase2.csv"), "A", 0.4, 0.3, TRUE)
```
...
```{r, results = "hide"}
UPC <- updateCorrespondenceTable(A, B, AStar, AB, AAStar,CSVout = file.path(tmp_dir,"updateCorrespondenceTableCase3.csv"), "none", 0.5, 0.3, TRUE)
```
...
```{r, results = "hide"}
UPC <- updateCorrespondenceTable(A, B, AStar, AB, AAStar, CSVout=file.path(tmp_dir,"updateCorrespondenceTableCase4.csv"), "B", 0.4, 0.3, TRUE)
```
...
```{r, results = "hide"}
UPC <- updateCorrespondenceTable(A, B, AStar, AB, AAStar,CSVout =file.path(tmp_dir,"updateCorrespondenceTableCase5.csv"), "B", 0.3, 0.7, TRUE)
```
...
```{r, results = "hide"}
UPC <- updateCorrespondenceTable(A, B, AStar, AB, AAStar, CSVout = file.path(tmp_dir,"updateCorrespondenceTableCase6.csv"), "B", 0.3, 0.6, FALSE)
```
...
```{r, results = "hide"}
system.time(NCT <- newCorrespondenceTable(file.path(tmp_dir,"names.csv"), CSVout = file.path(tmp_dir,"newCorrespondenceTableCase1.csv"), "A", 0.5, FALSE))
```
...
```{r, results = "hide"}
system.time(NCT <- newCorrespondenceTable(file.path(tmp_dir,"names.csv"), CSVout = file.path(tmp_dir,"newCorrespondenceTableCase2.csv"), "B", 0.5, FALSE))
```
...
```{r, results = "hide"}
system.time(NCT <- newCorrespondenceTable(file.path(tmp_dir,"names.csv"), CSVout = file.path(tmp_dir,"newCorrespondenceTableCase3.csv"), "B", 0.5, TRUE))
```
...
```{r, results = "hide"}
system.time(NCT <- newCorrespondenceTable(file.path(tmp_dir,"names.csv"), CSVout = file.path(tmp_dir,"newCorrespondenceTableCase4.csv"), "none", 0.96, TRUE))
```
