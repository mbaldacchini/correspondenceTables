...
# identify lower level using dataStructure()
 level_dt = dataStructure(endpoint,prefix, conceptScheme,language)
 # level = as.integer(level_dt[nrow(level_dt),2])

#result_ls = retrieveClassificationTable(endpoint,prefix,conceptScheme, level , language, CSVout, showQuery)
...
#    data_FAO[[i]] = dataStructure(endpoint,prefix, conceptScheme)
#  }
